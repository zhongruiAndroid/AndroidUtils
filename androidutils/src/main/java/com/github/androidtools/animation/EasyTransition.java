package com.github.androidtools.animation;
...
public class EasyTransition {
     ...
     * @param options Transition options, using {@link EasyOptions#makeTransitionOptions(Activity, View...)}
     *                to build your options
     */
    public static void startActivity(Intent intent, EasyOptions options) {
        options.update();
     ...
     *                    to build your options
     */
    public static void startActivityForResult(Intent intent, int requestCode, EasyOptions options) {
        options.update();
        intent.putParcelableArrayListExtra(EASY_TRANSITION_OPTIONS, options.getAttrs());
        Activity activity = options.getActivity();
    ...
    public static void enter(Activity activity, long duration, TimeInterpolator interpolator, Animator.AnimatorListener listener) {
        ...
        ArrayList<EasyOptions.ViewAttrs> attrs =
    ...
    private static void runEnterAnimation(Activity activity,
        ...
        for (final EasyOptions.ViewAttrs attr : attrs) {
    ...
    public static void exit(Activity activity, long duration, TimeInterpolator interpolator) {
        Intent intent = activity.getIntent();
        ArrayList<EasyOptions.ViewAttrs> attrs = intent.getParcelableArrayListExtra(EASY_TRANSITION_OPTIONS);
