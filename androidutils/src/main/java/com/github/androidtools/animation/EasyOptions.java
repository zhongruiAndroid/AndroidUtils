...
/**
 * Transition options, using {@link EasyOptions#makeTransitionOptions(Activity, View...)}
...
public class EasyOptions {
    ...
    public EasyOptions(Activity activity, View[] views) {
     ...
     */
    public static EasyOptions makeTransitionOptions(Activity activity, View... views) {
        return new EasyOptions(activity, views);
    }
